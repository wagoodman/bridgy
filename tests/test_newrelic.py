...
def test_newrelic_instances():
    ...
    expected_instances = [
        Instance(name=u'coolcucumber', address=None, aliases=None, source='acct:account_number (newrelic)', container_id=u'cc3456789098765432', type='CONTAINER'), 
        ...
        Instance(name=u'awesomecontainer', address=u'672.16.223.200', aliases=None, source='acct:account_number (newrelic)', container_id=u'123456789098765432', type='CONTAINER'), 
        Instance(name=u'ardvark?', address=None, aliases=None, source='acct:account_number (newrelic)', container_id=u'dd3456789098765432', type='CONTAINER'), 
